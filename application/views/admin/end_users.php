...
<div class="ch-container">
    ...
    <div class="box-header well" data-original-title="">
        <h2><!-- <i class="glyphicon glyphicon-user"></i> -->End Users</h2>
    ...
    <input type="hidden" class="table_name" value="saai_end_users">
...
<tbody>
    <?php foreach ($endusers_list as $endusr): ?>
        <tr>
            ...
            <td class="center">
                <a class="btn btn-info" href="<?php echo base_url(); ?>admin/users/edit_end_users/<?php echo $endusr["user_id"] ?>">
                    <i class="glyphicon glyphicon-edit icon-white"></i>
                    Edit
                </a>
