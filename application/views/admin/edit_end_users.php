        ...
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                ...
                <div class="box-icon">
                    ...
                    <a href="<?php echo base_url(); ?>admin/users/end_users" class="btn  btn-round btn-default"><i
...
<?php } ?>
                ...
                <?php ?>
                <form role="form" method="POST" action="<?php echo base_url(); ?>admin/users/edit_end_users/<?php echo $enduser_data['user_id'];?>" class="form_submit" name="edit_enduser_form" id="edit_enduser_form">
